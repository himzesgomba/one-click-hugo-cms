    ...
    <div class="contact-container">
        <div class="contactForm">
            <form action="https://formsubmit.co/ajanlat@himzesgomban.hu" method="POST">
                ...
                <div class="inputBox">
                    <select class="option" name="szolgaltatas" id="egyebselect" multiple style="display:block">
                ...
                <div class="inputBox">
                    <select class="opovoda" name="szolgaltatas" id="ovodaiselect" multiple style="display:block">
